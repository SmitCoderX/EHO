...
abstract class BaseActivity : AppCompatActivity() {
    ...
    open fun showSnackBar(context: Context, message: String?) {
        var view = (findViewById<View>(android.R.id.content) as ViewGroup).getChildAt(0) as ViewGroup
        val snackbar = Snackbar.make(view, message.toString(), Snackbar.LENGTH_LONG).setActionTextColor(Color.WHITE)
